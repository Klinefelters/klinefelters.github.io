...
export default function ProjectCard({ title, description, buttons, video }) {
    ...
    return (
        <Flex flexDirection="column" p="4" maxW="800px" color="white" bg="rgba(61, 181, 230, .25)" borderRadius="3xl">
            ...
            >
                ...
                >
                    <Text color="white" m="5" textAlign="center" fontSize="md" opacity={!isHovered ? 1 : 0} transition="opacity 0.5s">{description}</Text>
                </Flex>
            </Box >
            <Spacer />
